...
module.exports = "<div class=\"container\"\n  fxLayout=\"column\"\n  fxLayoutGap=\"10px\">\n\n  <div fxFlex>\n    <div>\n        <h3>About Us</h3>\n        <hr>\n    </div>\n  </div>\n\n  <div fxFlex>\n    <div fxLayout=\"column\" fxLayout.gt-sm=\"row\">\n      <div fxFlex=\"70\">\n        <h2>Our History</h2>\n        <p>Started in 2018, Gavin Belson quickly established itself as a culinary icon par excellence in Bay Area.</p>\n      </div>\n      <div fxFlex=\"30\">\n        <mat-card>\n          <mat-card-header>\n            <mat-card-title>\n            <h2>Facts At a Glance</h2>\n            </mat-card-title>\n          </mat-card-header>\n          <mat-card-content>\n            <dl>\n              <dt>Started</dt>\n              <dd>3 Aug. 2018</dd>\n              <dt>Major Stake Holder</dt>\n              <dd>TW Fine Foods Inc.</dd>\n              <dt>Last Year's Turnover</dt>\n              <dd>$1,234,567</dd>\n              <dt>Employees</dt>\n              <dd>4000</dd>\n            </dl>\n          </mat-card-content>\n        </mat-card>\n      </div>\n    </div>\n  </div>\n\n  <div fxFlex>\n    <mat-card>\n      <blockquote>\n        <h3>We’re proud to put our name on the next generation of food app..</h3>\n        <footer>-- Gavin Belson,\n          <cite>Gavin Belson, Founder and CEO, 2018</cite>\n        </footer>\n      </blockquote>\n    </mat-card>\n  </div>\n\n\n  <div fxFlex>\n    <h2>Corporate Leadership</h2>\n      <mat-list *ngIf=\"leaders\" [@expand]>\n        <mat-list-item *ngFor=\"let leader of leaders\">\n          <img mat-list-avatar src=\"{{BaseURL + leader.image}}\" alt={{leader.name}}/>\n          <h4 mat-line>{{leader.name}} {{leader.abbr}}</h4>\n          <p mat-line>{{leader.designation}}</p>\n          <p mat-line>{{leader.description}}</p>\n        </mat-list-item>\n      </mat-list>\n  </div>\n</div>\n"
...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(leaderService, route, location, BaseURL) {
    ...
    AboutComponent.prototype.ngOnInit = function () {
        ...
        this.leaderService.getLeaders()
            .subscribe(function (leaders) { return _this.leaders = leaders; }, function (errmess) { return _this.errMess = errmess.message; });
    };
    AboutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_leader_service__WEBPACK_IMPORTED_MODULE_3__["LeaderService"],
...
/* harmony import */ var _app_routing_app_routing_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./app-routing/app-routing.module */ "./src/app/app-routing/app-routing.module.ts");
...
/* harmony import */ var _services_dish_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./services/dish.service */ "./src/app/services/dish.service.ts");
...
/* harmony import */ var _shared_baseurl__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./shared/baseurl */ "./src/app/shared/baseurl.ts");
/* harmony import */ var ngx_restangular__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ngx-restangular */ "./node_modules/ngx-restangular/fesm5/ngx-restangular.js");
/* harmony import */ var _shared_restConfig__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./shared/restConfig */ "./src/app/shared/restConfig.ts");
/* harmony import */ var _leader_leader_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./leader/leader.component */ "./src/app/leader/leader.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _leader_leader_component__WEBPACK_IMPORTED_MODULE_34__["LeaderComponent"],
            ...
            imports: [
                ...
                ngx_restangular__WEBPACK_IMPORTED_MODULE_32__["RestangularModule"].forRoot(_shared_restConfig__WEBPACK_IMPORTED_MODULE_33__["RestangularConfigFactory"])
            ],
            providers: [
                _services_dish_service__WEBPACK_IMPORTED_MODULE_24__["DishService"],
                { provide: 'BaseURL', useValue: _shared_baseurl__WEBPACK_IMPORTED_MODULE_31__["baseURL"] }
            ],
...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            _services_feedback_service__WEBPACK_IMPORTED_MODULE_3__["FeedbackService"]])
    ], ContactComponent);
...
var DishdetailComponent = /** @class */ (function () {
    ...
    DishdetailComponent.prototype.changeColor = function (tabclicked) {
        this.isLike = !this.isLike;
    };
    DishdetailComponent.prototype.changeStyle = function (tabclicked) {
        this.isLike = !this.isLike;
    };
...
module.exports = ".jumbotron {\n  margin: 0px auto;\n  padding: 70px 30px;\n  background: #ae81be;\n  color: floralwhite;\n  min-height: 150px; }\n\n.active {\n  background: #76066c; }\n\n.header {\n  height: 40vh;\n  background-image: linear-gradient(to right bottom, rgba(174, 129, 190, 0.8), rgba(118, 6, 108, 0.8)), url('header.jpg');\n  background-position: top;\n  position: relative;\n  -webkit-clip-path: polygon(0 0, 100% 0, 100% 75vh, 0 100%);\n          clip-path: polygon(0 0, 100% 0, 100% 75vh, 0 100%); }\n"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(dialog, BaseURL) {
        this.dialog = dialog;
        this.BaseURL = BaseURL;
    }
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.dishService.getFeaturedDish()
            .subscribe(function (dish) { return _this.dish = dish; }, function (errmess) { return _this.errMess = errmess.message; });
        this.promotionService.getFeaturedPromotion()
            .subscribe(function (promo) { return _this.promotion = promo; }, function (errmess) { return _this.errMess = errmess.message; });
        this.leaderService.getFeaturedLeader()
            .subscribe(function (leader) { return _this.leader = leader; }, function (errmess) { return _this.errMess = errmess.message; });
    };
...
/***/ "./src/app/leader/leader.component.scss":
/*!**********************************************!*\
  !*** ./src/app/leader/leader.component.scss ***!
  \**********************************************/
/*! no static exports found */
...
var LeaderComponent = /** @class */ (function () {
    ...
    LeaderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./leader.component.scss */ "./src/app/leader/leader.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], LeaderComponent);
...
var DishService = /** @class */ (function () {
    ...
    DishService.prototype.getDishIds = function () {
        return this.getDishes()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (dishes) { return dishes.map(function (dish) { return dish.id; }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (error) { return error; }));
    };
...
var PromotionService = /** @class */ (function () {
    ...
    PromotionService.prototype.getFeaturedPromotion = function () {
        return this.restangular.all('promotions')
            .getList({ featured: true })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (promos) { return promos[0]; }));
    };
...
module.exports = __webpack_require__(/*! /Users/light0617/WorkPlace/angular/AngularFoodApp/src/main.ts */"./src/main.ts");
